                ...
                <div class="container position-relative rounded-1 p-0">
                    <div class="suite-img-slider bg-transparent" style="border-radius: 5px">
                        ...
                        <div class="mySlides position-relative">
                                 @if($course->id % 3 == 1)
                                    <img class="object-fit-cover" src="{{ asset('book.jpg') }}" style="object-fit: contain; width: 100%; border-radius: 5px 5px 0 0; height: 300px" >
                                @elseif($course->id % 3 == 2)
                                    <img class="object-fit-cover" src="{{ asset('book 2.jpg') }}" style="object-fit: contain; width: 100%; border-radius: 5px 5px 0 0; height: 300px" >
                                @elseif($course->id % 3 == 0)
                                    <img class="object-fit-cover" src="{{ asset('book3.jpg') }}" style="object-fit: contain; width: 100%; border-radius: 5px 5px 0 0; height: 300px" >
                                @endif
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                <svg class="me-2 mt-1" width="13" height="14" viewBox="0 0 13 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="h-4 w-4">
                                    <path
                                        d="M4.15633 0.65625C4.15633 0.292578 3.86375 0 3.50007 0C3.13639 0 2.8438 0.292578 2.8438 0.65625V1.75H1.75003C0.784781 1.75 0 2.53477 0 3.5V3.9375V5.25V12.25C0 13.2152 0.784781 14 1.75003 14H10.5002C11.4655 14 12.2502 13.2152 12.2502 12.25V5.25V3.9375V3.5C12.2502 2.53477 11.4655 1.75 10.5002 1.75H9.40643V0.65625C9.40643 0.292578 9.11385 0 8.75017 0C8.38649 0 8.09391 0.292578 8.09391 0.65625V1.75H4.15633V0.65625ZM1.31253 5.25H10.9377V12.25C10.9377 12.4906 10.7408 12.6875 10.5002 12.6875H1.75003C1.5094 12.6875 1.31253 12.4906 1.31253 12.25V5.25ZM2.62505 7.65625C2.62505 8.01992 2.91763 8.3125 3.28131 8.3125H8.96892C9.3326 8.3125 9.62519 8.01992 9.62519 7.65625C9.62519 7.29258 9.3326 7 8.96892 7H3.28131C2.91763 7 2.62505 7.29258 2.62505 7.65625ZM3.28131 9.625C2.91763 9.625 2.62505 9.91758 2.62505 10.2812C2.62505 10.6449 2.91763 10.9375 3.28131 10.9375H6.34387C6.70755 10.9375 7.00013 10.6449 7.00013 10.2812C7.00013 9.91758 6.70755 9.625 6.34387 9.625H3.28131Z"
                                        fill="#424242"></path>
                                </svg>
                                <div class="">
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Course Duration</p>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Course Detail</p>
                                    <p class="mb-0"><a href="{{$course->link}}">{{$course->link}}</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">TUITION FEES</p>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Study Mode</p>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Our Address</p>
                                    <p class="mb-0">{{$course->address}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
