                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="card-text border-bottom border-top my-3">
                                                <div class="d-flex align-items-center justify-content-between py-2">
                                                    <div
                                                        ...
                                                        <p class="small mb-0">{{$sch->application_deadline}}</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="small mb-0"><a href="{{$sch->link}}">{{$sch->link}}</a></p>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <p class="mb-0">{{$sch->description}}</p>
                                            </div>
