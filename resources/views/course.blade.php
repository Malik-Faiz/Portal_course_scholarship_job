...
@if(session('success'))
    ...
    <div class="container-xl pb-6 property_ads">
        <div class="row justify-content-center my-5">
            <div class="col-lg-6">
                <input type="text" id="courseSearch" class="form-control mb-3" placeholder="Search for courses..." onkeyup="filterCourses()">
            </div>
        </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div
                                                ...
                                                <p class="mb-0">Course Detail: <a href="{{$course->link}}">{{$course->link}}</a></p>
                                                <p class="mb-0">Our Address: {{$course->address}}</p>
                                            </div>
