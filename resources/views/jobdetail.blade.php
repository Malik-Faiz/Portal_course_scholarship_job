                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                <span><img class="mb-1 me-1" src="{{asset('assets-2/assets/images/icons/location.png')}}" alt="" />Job Location</span>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Job Detail</p>
                                    <p class="mb-0"><a href="{{$job->link}}">{{$job->link}}</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Education</p>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Job Skills</p>
