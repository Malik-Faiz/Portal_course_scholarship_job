...
@if(session('success'))
    ...
    @endif
        ...
        <nav class="navBar py-sm-3 px-4 bg-white Shadow d-flex align-items-center fixed-top">
            <a class="navbar-brand CompanyLogo" href="#"> <img width="41.1" height="35.6" src="{{asset('assets/images/Logo/project-logo.png')}}" /> </a>
                ...
                <ul class="navbar-nav mb-lg-0">
                    <li class="Users-profile nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="mb-2 px-3"><a class="dropdown-item active" href="{{ route('profile.update', ['id' => $user->id]) }}" target="_blank">My Profile</a></li>
                            ...
                            <div class="modal-body p-4 pb-0">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control mb-1 border-0 bg-body" name="address" placeholder="Please Enter" required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table class="table Search-Employees table-borderless table-striped table-hover">
                        <thead class="Employees-border sticky-top bg-white" style="z-index: 1 !important">
                            <tr class="small">
                                ...
                                <th scope="col" class="pb-3 dashed-border-bottom">Location</th>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <label class="form-label mb-1">Address</label>
                                                        <input type="text" class="form-control mb-1 border-0 bg-body" name="address" value="{{ $course->address }}" required>
                                                    </div>
                                                </div>
                                                <div class="modal-footer border-0 p-4">
