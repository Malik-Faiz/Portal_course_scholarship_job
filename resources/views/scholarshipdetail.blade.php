                ...
                <div class="container position-relative rounded-1 p-0">
                    <div class="suite-img-slider bg-transparent" style="border-radius: 5px">
                        ...
                        <div class="mySlides position-relative">
                            ...
                            <img class="object-fit-cover" src="{{ asset($scholarship->image) }}"
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Scholarship Name</p>
                                    <p class="mb-0"> {{$scholarship->name}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Scholarship Detail</p>
                                    <p class="mb-0"><a href="{{$scholarship->link}}">{{$scholarship->link}}</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">APPLICATION DEADLINE</p>
                                    <p class="mb-0">{{$scholarship->application_deadline}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Scholarship Description</p>
