  ...
  <div class="Page-heading text-center">
    <div class="d-flex justify-content-center">
      <div class="col-12 col-md-6">
        <h1 class="text-light text-uppercase">Browse thousands of degrees from around the world</h1>
                    ...
                    <div class="card" style="width: 100%;">
                        <div class="carousel-inner rounded-start">
                            <div class="carousel-item property-images active" style="width: 100%; height: 300px;">
                                <img src="{{ asset($scholarship->image) }}" class="d-block img-fluid" style="object-fit: contain; width: 100%; height: 100%;">
            ...
            <div class="col-md-4 mb-4 university-card" style="display: {{ $index < 3 ? 'block' : 'none' }};">
                <div class="card" style="width: 100%;">
                    <div id="carouselcountries{{ $index }}" class="carousel slide caruselSlides">
                        <div class="carousel-inner rounded-start">
                            <div class="carousel-item property-images active" style="width: 100%; height: 300px;">
                                <img src="{{ $university->image }}" class="d-block object-fit-contain" style="object-fit: contain; width: 100%; height: 100%;">
                                <div class="shadow-overlay"></div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                                <div>
                                <p class="card-text">Visit Website: <a href="{{$university->university_link}}">{{$university->university_link}}</a></p>
                                </div>
            ...
            <div class="row" id="job-container">
                ...
                <div class="col-md-4 mb-4 job-card" style="display: {{ $index < 3 ? 'block' : 'none' }};">
                    <div class="card" style="width: 100%;">
                        <div class="carousel-inner rounded-start">
                            <div class="carousel-item property-images active" style="width: 100%; height: 300px;">
                                    <img src="{{$job->job_image}}" class="d-block object-fit-contain" style="object-fit: contain; width: 100%; height: 100%;">
